...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/27 14:08:13 by truello           #+#    #+#             */
/*   Updated: 2023/08/27 14:12:20 by truello          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

const char	g_coin_hg = 'o';
const char	g_coin_hd = 'o';
const char	g_coin_bg = 'o';
const char	g_coin_bd = 'o';
const char	g_line = '-';
const char	g_col = '|';
const char	g_inter = ' ';
